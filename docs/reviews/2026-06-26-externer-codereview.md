> **Hinweis (Ablage):** Dieser externe Review wurde gegen den `main`-Stand erstellt
> („Add files via upload"), nicht gegen den aktuellen Feature-Branch. Mehrere P1/P3-Punkte
> sind dort bereits behoben. Die **Bewertung & Erledigungsstatus** je Punkt steht in
> `docs/ideen-backlog.md` → Abschnitt „Externer Code-Review (26.06.2026) — Bewertung & Status".
> Der Reviewtext selbst ist unverändert übernommen.
